...
<link rel="stylesheet" href="<?php echo url('/');?>/css/morris.css" type="text/css"/>
<!-- Graph CSS -->
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/') }}/dashboard">Home</a><i class="fa fa-angle-right"></i>Kupon <i class="fa fa-angle-right"></i> Update Barang</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
 		<div class="grid-form1">
 		<h2 id="forms-example" class="">Update Barang</h2>
    @if(session('updated'))
  ...
  <div class="form-group">
    ...
    <select class="form-control1" name="kategori_id">
    @foreach ($kategori_barang as $kategori)
      @if($kategori->kategori_id == $barang->kategori_id)
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" value = "{{ $barang->harga_beli }}" name="harga_beli">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <select class="form-control1" name="id_supplier">
      @foreach ($supplier_barang as $supplier)
        @if($supplier->id_supplier == $barang->id_supplier)
