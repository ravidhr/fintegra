...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/') }}/dashboard">Home</a><i class="fa fa-angle-right"></i>Kupon <i class="fa fa-angle-right"></i> Tambah Kupon</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
 		<div class="grid-form1">
 		<h2 id="forms-example" class="">Tambah Kupon</h2>
    @if(session('saved'))
    <div class="alert alert-success">
      Kupon telah ditambahkan
      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
    </div>
    @endif
 		<form action="{{ url('/') }}/kupon/add" method="post">
