...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/') }}/dashboard">Home</a><i class="fa fa-angle-right"></i>Barang <i class="fa fa-angle-right"></i> Tambah Barang</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
 		<div class="grid-form1">
 		<h2 id="forms-example" class="">Tambah Barang</h2>
    @if(session('inserted'))
