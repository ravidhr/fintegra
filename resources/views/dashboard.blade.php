...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/') }}/dashboard">Home</a> <i class="fa fa-angle-right"></i></li>
            </ol>
<!--four-grids here-->
					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li><a href="{{ url('/') }}/penjualan"><i class="fa fa-table" aria-hidden="true"></i>  <span>Penjualan</span><div class="clearfix"></div></a></li>
