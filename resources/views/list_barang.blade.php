					...
					<div class="w3layouts-left">
							...
							<!--search-box-->
								<div class="w3-search-box">
									<form action="{{ url('/') }}/barang/list" method="post">
										<input type="text" placeholder="Cari barang" name="cari" required="">
                    {{ csrf_field() }}
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/') }}/barang/list">Home</a><i class="fa fa-angle-right"></i>List Barang</li>
            </ol>
